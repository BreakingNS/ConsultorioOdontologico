...
@WebServlet(name = "SvFiltrarHora1", urlPatterns = {"/SvFiltrarHora1"})
public class SvFiltrarHora1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(fechaString != null && !fechaString.isEmpty()){
            ...
            try {
                ...
                Logger.getLogger(SvFiltrarHora1.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
        ...
        for(Turno turno : listaTurnosInicio){
            System.out.println(turno.getFecha_turno() + " - " + fecha);
